...
set ifError=0
copy runsim.gms runDynTar.gms
call gams runDynTar --simName=DynTar --BaUName=BaU --startName=BaU --startYear=2020 --simType=RcvDyn --ifCal=0 --baseName=%baseName% --odir=%oDir% -idir=..\model -scrdir=%oDir% -ps=99999 -pw=150 -errmsg=1
echo.ErrorLevel = !errorlevel!
if %errorlevel% NEQ 0 (
   goto simError
)
