...
nd0(r0,a0) = sum((i0,i,commf)$(mapi(i0,i) and mapif(i, commf) and not frt(commf) and not e(commf)), vdfp(i0,a0,r0) + vmfp(i0,a0,r0))$acr0(a0)
           + sum((i0,i,commf)$(mapi(i0,i) and mapif(i, commf) and not feed(commf) and not e(commf)), vdfp(i0,a0,r0) + vmfp(i0,a0,r0))$alv0(a0)
           + sum((i0,i,commf)$(mapi(i0,i) and mapif(i, commf) and not e(commf)), vdfp(i0,a0,r0) + vmfp(i0,a0,r0))$(not acr0(a0) and not alv0(a0))
           ;
$batinclude aggra sigman1  nd0 sigman10

nd0(r0,a0) = sum((i0,i,commf)$(mapi(i0,i) and mapif(i, commf) and frt(commf)), vdfp(i0,a0,r0) + vmfp(i0,a0,r0))$acr0(a0)
           + sum((i0,i,commf)$(mapi(i0,i) and mapif(i, commf) and feed(commf)), vdfp(i0,a0,r0) + vmfp(i0,a0,r0))$alv0(a0)
           + 0$(not acr0(a0) and not alv0(a0))
           ;
$batinclude aggra sigman2  nd0 sigman20

nd0(r0,a0) = sum((i0,i,commf)$(mapi(i0,i) and mapif(i, commf) and iw(commf)), vdfp(i0,a0,r0) + vmfp(i0,a0,r0)) ;

$batinclude aggra sigmawat  nd0 sigmawat0

nrg0(r0,a0) = sum((e0,i,e)$(mapi(e0,i) and mapif(i, e)), vdfp(e0,a0,r0) + vmfp(e0,a0,r0)) ;

$batinclude aggrav sigmae nrg0 sigmae0

nrg0(r0,a0) = sum((e0,i,e)$(mapi(e0,i) and mapif(i, e) and not mape("ely",e)), vdfp(e0,a0,r0) + vmfp(e0,a0,r0)) ;

display nrg0, sigmanely ;
$batinclude aggrav sigmanely nrg0 sigmanely0
display sigmanely0 ;

nrg0(r0,a0) = sum((e0,i,e)$(mapi(e0,i) and mapif(i, e) and mape("oil",e) and mape("gas",e)), vdfp(e0,a0,r0) + vmfp(e0,a0,r0)) ;

$batinclude aggrav sigmaolg nrg0 sigmaolg0

loop(nrg,
   nrg0(r0,a0) = sum((e0,i,e)$(mapi(e0,i) and mapif(i, e) and mape(nrg,e)), vdfp(e0,a0,r0) + vmfp(e0,a0,r0)) ;
...
s_c(k,r) = sum((i0,i,commf,r0)$(mapi(i0,i) and mapif(i,commf) and mapk(commf,k) and mapr(r0,r)), vdpp(i0,r0) + vmpp(i0,r0)) ;
e_c(k,r)$s_c(k,r)
          = sum((i0,i,commf,r0)$(mapi(i0,i) and mapif(i,commf) and mapk(commf,k) and mapr(r0,r)), incPar(i0,r0)*(vdpp(i0,r0) + vmpp(i0,r0)))
          / s_c(k,r) ;
b_c(k,r)$s_c(k,r)
          = sum((i0,i,commf,r0)$(mapi(i0,i) and mapif(i,commf) and mapk(commf,k) and mapr(r0,r)), subPar(i0,r0)*(vdpp(i0,r0) + vmpp(i0,r0)))
          / s_c(k,r) ;
...
incElas0(k,r) = sum((i0,i,commf,r0)$(mapi(i0,i) and mapif(i, commf) and mapk(commf,k) and mapr(r0,r)), vdpp(i0, r0) + vmpp(i0, r0)) ;
incElas0(k,r)$incElas0(k,r) = sum((i0,i,commf,r0)$(mapi(i0,i) and mapif(i, commf) and mapk(commf,k) and mapr(r0,r)), incElas(r0,i0)*(vdpp(i0, r0) + vmpp(i0, r0)))/incElas0(k,r) ;
...
sigmam0(r,commf) = sum((r0,i0,i)$(mapi(i0,i) and mapif(i,commf) and mapr(r0,r)),
   sum(a0, (vdfp(i0,a0,r0)+ vmfp(i0,a0,r0))) + (vdpp(i0,r0) + vmpp(i0,r0)) + (vdgp(i0, r0) + vmgp(i0, r0))) ;

sigmam0(r,commf)$sigmam0(r,commf) = sum((r0,i0,i)$(mapi(i0,i) and mapif(i,commf) and mapr(r0,r)), sigmam(r0,i0)*
...
sigmaw0(r,commf) = sum((r0,i0,i)$(mapi(i0,i) and mapif(i,commf) and mapr(r0,r)), sum(a0, vmfp(i0,a0,r0)) + vmpp(i0,r0) + vmgp(i0, r0)) ;
sigmaw0(r,commf)$sigmaw0(r,commf) =
   sum((r0,i0,i)$(mapi(i0,i) and mapif(i,commf) and mapr(r0,r)), sigmaw(r0,i0)*(sum(a0, vmfp(i0,a0,r0)) + vmpp(i0,r0) + vmgp(i0, r0)))/sigmaw0(r,commf) ;
...
*  Top level CET -- weight is domestic demand at market price + exports at market price + exports of TT services
   ...
   denom = sum((r0,i0,i)$(mapi(i0,i) and mapif(i,commf) and mapr(r0,r)),
               sum(a0, vdfb(i0,a0,r0)) + vdpb(i0,r0) + vdgb(i0, r0) + vdib(i0, r0) + sum(rp0, vxsb(i0,r0,rp0)))
         + sum((r0,marg,i)$(mapi(marg,i) and mapif(i,commf) and mapr(r0,r)), vst(marg,r0)) ;
   if(denom,
      omegax0(r,commf) = sum((r0,i0,i)$(mapi(i0,i) and mapif(i,commf) and mapr(r0,r)),
         ...
         + sum((r0,marg,i)$(mapi(marg,i) and mapif(i,commf) and mapr(r0,r)), omegax(r0,marg)*vst(marg,r0)
...
*  Second level CET -- weight is exports at market price
   ...
   denom = sum((r0,i0,i)$(mapi(i0,i) and mapif(i,commf) and mapr(r0,r)), sum(rp0, vxsb(i0,r0,rp0))) ;
   if(denom,
      omegaw0(r,commf) = sum((r0,i0,i)$(mapi(i0,i) and mapif(i,commf) and mapr(r0,r)), (omegaw(r0,i0)$(omegaw(r0,i0) ne inf))*sum(rp0, vxsb(i0,r0,rp0))
...
sigmamg0(commf) = sum((r0,marg,i)$(mapi(marg,i) and mapif(i,commf)), vst(marg,r0)) ;
sigmamg0(commf)$sigmamg0(commf) = sum((r0,marg,i)$(mapi(marg,i) and mapif(i,commf)),
...
loop(r,
   denom = sum((r0,a0,lnd0,a,actf,lb1)$(mapr(r0,r) and mapa(a0,a) and mapaf(a,actf) and not maplb(lb1,actf)), evfp(lnd0,a0,r0)) ;
   if(denom,
      omeganlb0(r) = sum((r0,a0,lnd0,a,actf,lb1)$(mapr(r0,r) and mapa(a0,a) and mapaf(a,actf) and not maplb(lb1,actf)), omeganlb(r0)*evfp(lnd0,a0,r0)) ;
...
loop((r,lb),
   denom = sum((r0,a0,lnd0,a,actf)$(mapr(r0,r) and mapa(a0,a) and mapaf(a,actf) and maplb(lb,actf)), evfp(lnd0,a0,r0)) ;
   if(denom,
      omegalb0(r,lb) = sum((r0,a0,lnd0,a,actf,lb0)$(mapr(r0,r) and mapa(a0,a) and mapaf(a,actf) and maplb(lb,actf) and maplb0(lb,lb0)), omegalb(r0,lb0)*evfp(lnd0,a0,r0)) ;
...
loop((r,actf),
   denom = sum((r0,a0,nrf0,a)$(mapr(r0,r) and mapa(a0,a) and mapaf(a,actf)), evfp(nrf0,a0,r0)) ;
   etanrf0(r,actf)$denom = sum((r0,a0,nrf0,a)$(mapr(r0,r) and mapa(a0,a) and mapaf(a,actf)), etanrf(r0,a0)*evfp(nrf0,a0,r0))/denom ;
) ;
...
display evfp ;
loop((r,actf),
   denom = sum((r0,a0,cap0,a)$(mapr(r0,r) and mapa(a0,a) and mapaf(a,actf)), evfp(cap0,a0,r0)) ;
   invElas0(r,actf)$denom = sum((r0,a0,cap0,a)$(mapr(r0,r) and mapa(a0,a) and mapaf(a,actf)), invElas(r0,a0)*evfp(cap0,a0,r0))/denom ;
$ontext
...
omegam0(r,l) = sum((r0,l0,a0,a,actf,rur)
             $(mapr(r0,r) and mapa(a0,a) and mapaf(a,actf) and mapzf(rur,actf) and mapf(l0,l)),
                  evfb(l0,a0,r0)) ;
omegam0(r,l)$omegam0(r,l) = sum((r0,l0,a0,a,actf,rur)
             $(mapr(r0,r) and mapa(a0,a) and mapaf(a,actf) and mapzf(rur,actf) and mapf(l0,l)),
