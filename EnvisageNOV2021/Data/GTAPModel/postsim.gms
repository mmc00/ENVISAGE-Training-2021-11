...
sam(r,"ctax",a,t)  = ctax.l(r,a,t)*px0(r,a)*xp0(r,a)*px.l(r,a,t)*xp.l(r,a,t) ;
...
*  'Old' method
   ...
   sam(r,gov,"ctax",t)  = sum(a,ctax.l(r,a,t)*px0(r,a)*xp0(r,a)*px.l(r,a,t)*xp.l(r,a,t)) ;
...
*  'Standard GTAP' method
   ...
   sam(r,"regY","ctax",t)  = sum(a,ctax.l(r,a,t)*px0(r,a)*xp0(r,a)*px.l(r,a,t)*xp.l(r,a,t)) ;
